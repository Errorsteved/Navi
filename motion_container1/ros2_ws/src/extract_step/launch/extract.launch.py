...
def generate_launch_description():
    return LaunchDescription([
        Node(
            package="extract_step",
            executable="extract_step_node",
            name="extract_step_node",
            env={
                'HOME': '/root',
                'AMENT_PREFIX_PATH': ament_prefix_path,
                'LD_LIBRARY_PATH': '/opt/ros/foxy/lib' +
                                   ':/ros2_ws/install/extract_step/lib' +
                                   ':/ros2_ws/install/extract_step_msgs/lib',
                "PYTHONPATH": os.environ.get("PYTHONPATH", "") + ":" +
                              "/ros2_ws/install/extract_step_msgs/lib/python3.8/site-packages:" +
                              "/ros2_ws/install/extract_step/lib/python3.8/site-packages",
            },
        )
    ])